...
const Navigation = () => {
  ...
  return (
    <>
      <nav
        className="fixed z-[100] top-6 left-1/2 -translate-x-1/2 w-[92%] md:w-[90%] max-w-4xl bg-white/95 backdrop-blur-md shadow-lg border border-slate-200/50 rounded-full overflow-hidden"
      >
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            >
              Sakthi<span className="text-violet-500">.</span>
            </a>
              ...
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    {link.name}
                    <span
                      className={`absolute -bottom-1 left-0 h-0.5 bg-violet-600 transition-all duration-300 rounded-full ${isActive ? "w-full" : "w-0 group-hover:w-full"
                        }`}
                    />
                  </a>
                );
            ...
            <div className="flex items-center">
              <a
                ...
                className="hidden md:block px-5 py-2 mr-0 bg-slate-900 text-white border border-transparent rounded-full font-semibold transition-all duration-300 text-xs tracking-wide whitespace-nowrap hover:bg-violet-600 hover:shadow-lg hover:shadow-violet-500/20"
              >
                Hire Me
              </a>
            ...
            >
              ...
              <div className="p-6 mt-auto border-t border-slate-50 space-y-4">
                <a
                  href="#contact"
                  onClick={(e) => scrollToSection(e, "#contact")}
                  className="flex items-center justify-center w-full py-4 bg-slate-900 text-white rounded-2xl font-bold text-sm shadow-xl shadow-slate-900/10 hover:bg-violet-600 transition-all active:scale-95"
                >
                  Start a Project
                </a>
